...
UserSchema.statics.quickEstimateClient = async function( estimate ){
  ...
  const safeEstimate = {
    ...(estimate || {}),
    interiorItems: Array.isArray(estimate?.interiorItems) ? estimate.interiorItems : [],
    exteriorItems: Array.isArray(estimate?.exteriorItems) ? estimate.exteriorItems : [],
    interiorIndividualItems: Array.isArray(estimate?.interiorIndividualItems) ? estimate.interiorIndividualItems : [],
    exteriorIndividualItems: Array.isArray(estimate?.exteriorIndividualItems) ? estimate.exteriorIndividualItems : [],
    paintQuality: typeof estimate?.paintQuality === 'string' ? estimate.paintQuality : '',
    paintBrand: typeof estimate?.paintBrand === 'string' ? estimate.paintBrand : ''
  }
  ...
  try {
    ...
    clientObject = {
      ...
      interiorDetail: safeEstimate.interiorDetail,
      interiorItems: safeEstimate.interiorItems,
      interiorIndividualItems: safeEstimate.interiorIndividualItems,
      interiorEstimate: await calculateInteriorEstimate(safeEstimate),
      interiorGallons: calculateInteriorGallonsCost(safeEstimate).gallons,
      interiorGallonsCost: calculateInteriorGallonsCost(safeEstimate).gallonsCost,
      interiorGallonsItems: calculateInteriorGallonsCost(safeEstimate).gallonsRequired,
      doorsAndDrawers: safeEstimate.doorsAndDrawers,
      insideCabinet: safeEstimate.insideCabinet,
      cabinetCondition: safeEstimate.cabinetCondition,
      cabinetDetail: safeEstimate.cabinetDetail,
      cabinetEstimate: await calculateCabinetsEstimate(safeEstimate),
      cabinetGallons: calculateCabinetsGallonsCost(safeEstimate).gallons,
      cabinetGallonsCost: calculateCabinetsGallonsCost(safeEstimate).gallonsCost,
      exteriorSquareFeet: safeEstimate.exteriorSquareFeet,
      exteriorCondition: safeEstimate.exteriorCondition,
      exteriorDetail: safeEstimate.exteriorDetail,
      exteriorItems: safeEstimate.exteriorItems,
      exteriorIndividualItems: safeEstimate.exteriorIndividualItems,
      exteriorEstimate: await calculateExteriorEstimate(safeEstimate),
      exteriorGallons: calculateExteriorGallonsCost(safeEstimate).gallons,
      exteriorGallonsCost: calculateExteriorGallonsCost(safeEstimate).gallonsCost,
      exteriorGallonsItems: calculateExteriorGallonsCost(safeEstimate).gallonsRequired,
      painters: safeEstimate.painters,
      hoursPerDay: safeEstimate.hoursPerDay,
      days: safeEstimate.days,
      paintBrand: safeEstimate.paintBrand,
      paintQuality: safeEstimate.paintQuality,
      warranty: safeEstimate.warranty,
      payments: safeEstimate.payments,
      deposit: safeEstimate.deposit,
      depositType: safeEstimate.depositType,
      painterTapeRolls: safeEstimate.painterTapeRolls,
      plasticRolls: safeEstimate.plasticRolls,
      dropCloths: safeEstimate.dropCloths,
      adjustment: safeEstimate.adjustment,
      userType: safeEstimate.userType
    }

          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="border-radius: 10px; background-color: #ffffff; border: 1px solid #ddd;">
            ...
            <tr>
              <td style="padding: 15px; width: 50%; vertical-align: top;">
                ...
                <p style="margin: 0;">${
                  Array.isArray(interiorIndividualItems) && interiorIndividualItems.length > 0
                    ? interiorIndividualItems.map((i) => `${i.title} - ${i.price}`).join(', ')
                    : '—'
                }</p>
              </td>
              <td style="padding: 15px; width: 50%; vertical-align: top;">
                ...
                <p style="margin: 0;">${
                  Array.isArray(interiorItems) && interiorItems.length
                    ? interiorItems
                        .map((i) => `<span style="display: inline-block; background-color: #eeeeee; padding: 5px 10px; border-radius: 20px; font-size: 12px; margin-right: 5px;">${i.title}</span>`)
                        .join('')
                    : '—'
                }</p>
              </td>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="border-radius: 10px; background-color: #ffffff; border: 1px solid #ddd;">
            ...
            <tr>
              <td style="padding: 15px; width: 50%; vertical-align: top;">
                ...
                <p style="margin: 0; font-weight: bold;">Extras</p>
                <p style="margin: 0;">${
                  Array.isArray(exteriorIndividualItems) && exteriorIndividualItems.length
                    ? exteriorIndividualItems.map((i) => `${i.title} - ${i.price}`).join(', ')
                    : '—'
                }</p>
              </td>
              <td style="padding: 15px; width: 50%; vertical-align: top;">
                    ...
                    <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden;">
                      ...
                      <tr>
                        <td style="padding: 0 20px 24px;">
                          <table width="100%" cellpadding="0" cellspacing="0" style="border-radius: 10px; background-color: #f9f9f9; border: 1px solid #ddd;">
                            <tr>
                              <td colspan="2" style="background-color: #3366ff; color: #ffffff; padding: 12px 15px; font-size: 16px; font-weight: bold; border-radius: 10px 10px 0 0;">
                                Client Information
                              </td>
                            </tr>
                            <tr>
